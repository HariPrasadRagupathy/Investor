...
public class InvestmentStatusList {
    ...
    public InvestmentStatusList(String status_id, String amount, String status_one, String status_two, int status_mode) {
